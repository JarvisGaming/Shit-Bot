...
bot = commands.Bot(command_prefix="sc!", intents=discord.Intents.all(), activity=discord.CustomActivity(name="you gave two shits? well i gave three"), help_command=None)
